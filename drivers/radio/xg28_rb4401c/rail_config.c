...
const RAIL_ChannelConfigEntry_t Protocol_Configuration_2_channels[] = {
  {
    .phyConfigDeltaAdd = NULL,
    .baseFrequency = 868000000,
    .channelSpacing = 1000000,
...
const RAIL_ChannelConfig_t Protocol_Configuration_2_channelConfig = {
  .phyConfigBase = Protocol_Configuration_1_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = Protocol_Configuration_2_channels,
  .length = 1U,
  .signature = 0UL,
  .xtalFrequencyHz = 39000000UL,
};
...
const RAIL_ChannelConfig_t *channelConfigs[] = {
  ...
  &Protocol_Configuration_2_channelConfig,
  NULL
};
